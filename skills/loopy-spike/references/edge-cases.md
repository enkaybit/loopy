...
3. If invoked from requirements discovery: recommend returning to requirements discovery to revisit the direction with the spike findings as input.
...
When requirements discovery identifies several spike-worthy questions:
...
5. **Exit ramp between spikes.** After each concludes: "Spike A complete. PRD updated. Ready to spike B, or return to requirements discovery?" The user might learn enough from spike A to skip B entirely.
